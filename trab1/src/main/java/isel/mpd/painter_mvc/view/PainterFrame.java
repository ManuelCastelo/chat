...
import isel.mpd.painter_mvc.app.commands.CommandFactory;
...
public class PainterFrame extends JFrame {
    ...
    private  class PaintMouselistener extends  MouseAdapter {
        ...
        public void mouseReleased(MouseEvent me) {
            ...
            configContext.setCommand(CommandFactory.buildMap(app, configContext, App.SHAPE_CMD_RECT));
            configContext.setCommand(CommandFactory.buildMap(app, configContext, App.SHAPE_CMD_TRIANGLE));
            configContext.setCommand(CommandFactory.buildMap(app, configContext, App.SHAPE_CMD_OVAL));
            configContext.setCommand(CommandFactory.buildMap(app, configContext, App.SHAPE_CMD_CIRCLE));
            configContext.setCommand(CommandFactory.buildMap(app, configContext, App.SHAPE_CMD_LINE));
            canvas.setPaintMode();
        }
    }
